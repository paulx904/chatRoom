...
class Ui_loginButton(object):
    def setupUi(self, loginButton):
        ...
        self.chatroom_people = QtWidgets.QTextBrowser(self.centralwidget)
        ...
        self.password_change_button = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.chaty = QtWidgets.QTextBrowser(self.centralwidget)
